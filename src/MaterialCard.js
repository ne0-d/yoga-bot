...
export default function ImgMediaCard(props) {
  ...
  return (
    <Card className={classes.root}>
      ...
      <CardActions style={{display:"flex", alignItems:"center", justifyContent:"cneter"}}>
        <Link to={`/App/${props.name}/${props.prt}`}>
          <Button style={{backgroundColor: "black", color: "white", boxShadow: "2px 2px 4px black"}} id="practice" href="#" size="small" color="primary">
            Practice
          </Button>
        </Link>
